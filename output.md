...
[ unclecode ](https://github.com/unclecode) / **[crawl4ai](https://github.com/unclecode/crawl4ai) ** Public
  ...
  * [ Star  81.7k ](https://github.com/login?return_to=%2Funclecode%2Fcrawl4ai)


  * [ Code ](https://github.com/unclecode/crawl4ai)
  * [ Issues 34 ](https://github.com/unclecode/crawl4ai/issues)
  * [ Pull requests 140 ](https://github.com/unclecode/crawl4ai/pulls)
...
| [crawl4ai](https://github.com/unclecode/crawl4ai/tree/main/crawl4ai "crawl4ai")  | [crawl4ai](https://github.com/unclecode/crawl4ai/tree/main/crawl4ai "crawl4ai")  | [chore: bump version to 0.9.3](https://github.com/unclecode/crawl4ai/commit/8cef8bd243728a49f722557d71f4086984c890c5 "chore: bump version to 0.9.3")  | Aug 31, 2026  |  
| [deploy/docker](https://github.com/unclecode/crawl4ai/tree/main/deploy/docker "This path skips through empty directories")  | [deploy/docker](https://github.com/unclecode/crawl4ai/tree/main/deploy/docker "This path skips through empty directories")  | [fix(playground): remove innerHTML round-trip to prevent DOM-based XSS](https://github.com/unclecode/crawl4ai/commit/0213355db08a3d7ea8ae572bf89af9e351bfb085 "fix\(playground\): remove innerHTML round-trip to prevent DOM-based XSS

forceHighlightElement\(\) reset the response code block with
`element.innerHTML = element.textContent`, which re-parsed
attacker-controlled crawled content \(e.g. a reflected page title in
metadata.title\) as live HTML and executed it in the operator's
authenticated Playground session. Removing the innerHTML round-trip
closes the sink; hljs.highlightElement\(\) re-highlights safely from
textContent and emits escaped markup.

Fixes GHSA-m446-hp3q-qfxp

\(cherry picked from commit 82950b4a1af26190edfed11b2d779f51750780b8\)")  | Aug 31, 2026  |  
| [docs](https://github.com/unclecode/crawl4ai/tree/main/docs "docs")  | [docs](https://github.com/unclecode/crawl4ai/tree/main/docs "docs")  | [docs: credit Zhixi (Jace) Sun by GitHub handle in security credits an…](https://github.com/unclecode/crawl4ai/commit/5ee246f822e28b1d0aeb622e12612f4551911fc4 "docs: credit Zhixi \(Jace\) Sun by GitHub handle in security credits and release notes")  | Aug 31, 2026  |  
...
| [tests](https://github.com/unclecode/crawl4ai/tree/main/tests "tests")  | [tests](https://github.com/unclecode/crawl4ai/tree/main/tests "tests")  | [fix(pdf): escape paragraph text in cleaned_html to prevent XSS](https://github.com/unclecode/crawl4ai/commit/ceaf6a3edec0124550951b3fe223a94d16b517c5 "fix\(pdf\): escape paragraph text in cleaned_html to prevent XSS

GHSA-7g3g-vhm6-79f3 \(medium\).

clean_pdf_text_to_html\(\) escaped every sink except the paragraph body, where
html.escape\(\) had been commented out. PDF paragraph text is attacker-controlled
and flows verbatim into cleaned_html and the crawl JSON, so injected markup such
as <img onerror=...> survived and executed when the result was rendered.

Re-enable html.escape\(\) on paragraph text. This is the "reliable injection
vector" half of the advisory; the primary DOM sink \(the Playground innerHTML
round-trip\) is fixed separately under GHSA-m446-hp3q-qfxp.

Adds tests/unit/test_pdf_html_escaping.py asserting < > " ' appear only as
entities in PDF cleaned_html.

Reported by Nguyen Tran Thanh Lam \(https://github.com/c240030\).

\(cherry picked from commit 9b312db8533bf4cc3e0a48ea7d48713e5ca30d36\)")  | Aug 31, 2026  |  
...
See deploy/docker/MIGRATION.md for the breaking-change migration guide.")  | Jun 18, 2026  |  
| [CHANGELOG.md](https://github.com/unclecode/crawl4ai/blob/main/CHANGELOG.md "CHANGELOG.md")  | [CHANGELOG.md](https://github.com/unclecode/crawl4ai/blob/main/CHANGELOG.md "CHANGELOG.md")  | [docs: credit Zhixi (Jace) Sun by GitHub handle in security credits an…](https://github.com/unclecode/crawl4ai/commit/5ee246f822e28b1d0aeb622e12612f4551911fc4 "docs: credit Zhixi \(Jace\) Sun by GitHub handle in security credits and release notes")  | Aug 31, 2026  |  
...
| [Dockerfile](https://github.com/unclecode/crawl4ai/blob/main/Dockerfile "Dockerfile")  | [Dockerfile](https://github.com/unclecode/crawl4ai/blob/main/Dockerfile "Dockerfile")  | [chore: bump version to 0.9.3](https://github.com/unclecode/crawl4ai/commit/8cef8bd243728a49f722557d71f4086984c890c5 "chore: bump version to 0.9.3")  | Aug 31, 2026  |  
...
| [README.md](https://github.com/unclecode/crawl4ai/blob/main/README.md "README.md")  | [README.md](https://github.com/unclecode/crawl4ai/blob/main/README.md "README.md")  | [docs: add the non-security bug fixes to the v0.9.3 release notes](https://github.com/unclecode/crawl4ai/commit/7245f984282d28b85946ce8d96f8e48d66da6c24 "docs: add the non-security bug fixes to the v0.9.3 release notes

The release carries 33 commits that landed on develop since 0.9.2 in
addition to the security fixes. The notes covered only the security
work, which under-reported what shipped.")  | Aug 31, 2026  |  
...
| [SECURITY-CREDITS.md](https://github.com/unclecode/crawl4ai/blob/main/SECURITY-CREDITS.md "SECURITY-CREDITS.md")  | [SECURITY-CREDITS.md](https://github.com/unclecode/crawl4ai/blob/main/SECURITY-CREDITS.md "SECURITY-CREDITS.md")  | [docs: credit Zhixi (Jace) Sun by GitHub handle in security credits an…](https://github.com/unclecode/crawl4ai/commit/5ee246f822e28b1d0aeb622e12612f4551911fc4 "docs: credit Zhixi \(Jace\) Sun by GitHub handle in security credits and release notes")  | Aug 31, 2026  |  
...
- Replace FastFilterChain with FilterChain
- Change license to Apache 2.0 with attribution clause")  | Feb 21, 2025  |  
| [docker-compose.yml](https://github.com/unclecode/crawl4ai/blob/main/docker-compose.yml "docker-compose.yml")  | [docker-compose.yml](https://github.com/unclecode/crawl4ai/blob/main/docker-compose.yml "docker-compose.yml")  | [fix(docker): align commented env var lines with the environment list](https://github.com/unclecode/crawl4ai/commit/fe4d4b493b04bcdf6b27c5ecef05eaf3152c7260 "fix\(docker\): align commented env var lines with the environment list
...
Co-Authored-By: Claude Opus 5 \(1M context\) <noreply@anthropic.com>")  | Aug 20, 2026  |  
